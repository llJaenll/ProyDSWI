...
-- ////////////////////////////////////////////////////////
-- --------------------------------------------------------
INSERT INTO tbProvincia VALUES
(1, 'CHACHAPOYAS ', 1),
(2, 'BAGUA', 1),
(3, 'BONGARA', 1),
(4, 'CONDORCANQUI', 1),
...
DROP PROCEDURE IF EXISTS USP_LISTA_UBIGEO(
	SELECT
		DEP.desDepartamento,
		PRO.desProvincia,
		DIS.desDistrito
	FROM tbDepartamento DEP JOIN tbProvincia PRO ON DEP.idDep=PRO.idDep
							JOIN tbDistrito DIS ON PRO.idProv = DIS.idProv
)
GO